      ...
      <div className="bg-white p-8 rounded shadow-md w-full md:w-1/2 lg:w-1/3">
        ...
        <form>
          ...
          <div className="mb-4">
            ...
            <Input type="email" id="email" className="form-input mt-1 block w-full rounded-md border-gray-300 shadow-sm" />
          </div>
          <div className="mb-4">
          ...
          <div className="mb-4">
            ...
            <Input type="password" id="confirmPassword" className="form-input mt-1 block w-full rounded-md border-gray-300 shadow-sm" />
          </div>
